...
const endpoints = {
  ...
  postSubject: "disciplinas/disciplinas",
  deleteSubject: "disciplinas/disciplinas/",
};
...
async function openEditPopup(id) {
  ...
  document.querySelector("#cargaHorariaDisciplinaEdit").value =
    dcpn.cargaHoraria;

  var professores = Array.isArray(dcpn.professor)
    ? dcpn.professor.map((p) => p.id.toString())
    : [];
...
function adicionar() {
  ...
  this.disciplina.descricao = document.querySelector(
    "#descricaoDisciplinaAdd"
  ).value;
  this.disciplina.codigo = document.querySelector("#codigoDisciplinaAdd").value;
  this.disciplina.cargaHoraria = document.querySelector(
    "#cargaHorariaDisciplinaAdd"
  ).value;
  var professoresSelect = document.querySelectorAll(
    "#professorDisciplinaAdd option:checked"
  );
  var professores = [];
  ...
  if (this.disciplina !== null) {
    post(endpoints.postSubject, this.disciplina)
      .then((result) => {
...
function remover() {
  ...
  fetchDelete(`${endpoints.deleteSubject}${this.selectedId}`)
    .then((result) => {
        atualizarTabela();
    })
    .catch((error) => {
...
function editar() {
  ...
  let newCargaHoraria = document.querySelector(
    "#cargaHorariaDisciplinaEdit"
  ).value;
  ...
  var professoresSelect = document.querySelectorAll(
    "#professorDisciplinaEdit option:checked"
  );
  var professores = [];
  ...
  put(endpoints.postSubject, this.disciplina)
    .then((result) => {
      console.log("Result ", result);
