...
function openEditPopup(id){
    ...
    document.getElementById('alunoDataDeNascimentoedit').value = alunoEditando.dataDeNascimento
...
function adicionar(){
    ...
    this.aluno.dataDeNascimento = document.getElementById('alunoDataDeNascimentoadd').value;
    ...
    if(this.aluno.nome != "" && this.aluno.cpf != ""){
        post('salvarAluno', this.aluno).then(result=>{
...
function remover(){
    ...
    get_params('deletarAluno', {id:this.selectedId}).then(result=>{
        atualizarTabela()
    }).catch(error=>{
    })
}
...
function editar(){
    ...
    var dataDeNascimento = document.getElementById("alunoDataDeNascimentoedit").value
