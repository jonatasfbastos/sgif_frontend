...
const endpoints = {
  getAllTiposDeItem: "tiposdeitem",
  updateTipoDeItem: "tiposdeitem/tipodeitem",
  saveTipoDeItem: "tiposdeitem/tipodeitem",
  deleteTipoDeItemById: "tiposdeitem/tipodeitem/",
};
...
function tipoDeItemDescricaoAddChange() {
  tipodeitem.descricao = document.getElementById(
    "tipoDeItemDescricaoAdd"
  ).value;
  console.log(tipodeitem);
}
...
function atualizarTabela() {
  get(endpoints.getAllTiposDeItem)
    .then((data) => {
...
function adicionar() {
  ...
  if (this.tipodeitem.nome != "" && this.tipodeitem.descricao != "") {
    post(endpoints.saveTipoDeItem, tipodeitem)
      .then((result) => {
...
function editar() {
  ...
  post(endpoints.saveTipoDeItem, this.tipodeitem)
    .then((result) => {
      console.log("Result ", result);
