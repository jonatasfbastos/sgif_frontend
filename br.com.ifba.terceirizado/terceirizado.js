...
function atualizarTabela(){
    ...
    this.terceirizadoList = data
    console.log('List terceirizados', this.terceirizadoList)
...
function openEditPopup(id){
    ...
    console.log('Id ',id)
    let pess = this.terceirizadosList.find(terceirizado=>{
        return terceirizado.id === id
    })

    console.log('terceirizado achado ', pess)
